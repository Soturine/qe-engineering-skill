...
EDGE_TYPES: dict[tuple[type[BaseModel], str], tuple[type[d.Artifact], ...]] = {
    ...
    (d.DecisionRule, "conditions"): (d.Claim, d.Constraint, d.State, d.Permission),
    (d.DecisionRule, "outcome"): (d.Claim,),
    (d.DecisionRule, "action"): (d.Action, d.Event),
    (d.ExistingTest, "requirement_ids"): (d.Requirement,),
    (d.ExistingTest, "criterion_ids"): (d.AtomicCriterion,),
    (d.ExistingTest, "actor_id"): (d.Actor,),
    (d.ExistingTest, "state_ids"): (d.State,),
    (d.ExistingTest, "channel_ids"): (d.Channel,),
    (d.ExistingTest, "risk_ids"): (d.Risk,),
    (d.ExistingTest, "oracle_ids"): (d.Oracle,),
    (d.ExistingTest, "path_ids"): (d.VerifiedPath,),
    (d.ExistingTest, "source_assumption_refs"): (d.Node, d.Claim),
