...
- Current stage: **M4.D1 — Technical Preview UX locally validated; remote validation pending**
...
- D1 local validation: 324 tests/evals passed against source and installed wheel, one local symlink
  skip; Ruff, format, mypy, dependency audit, schema reproduction and demo smoke passed
